/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     14-12-13 14:59:06                            */
/*==============================================================*/


drop table if exists AREA;

drop table if exists AREA_ATRIBUTO_AREA;

drop table if exists ASIGNACION_PERSONA_RECINTO_AREA;

drop table if exists ATRIBUTO_AREA;

drop table if exists ATRIBUTO_PERSONA;

drop table if exists ATRIBUTO_RECINTO;

drop table if exists ESTADO_PERSONA;

drop table if exists ESTADO_RECINTO;

drop table if exists HISTORIAL_OCUPAMIENTO_RECINTO;

drop table if exists HISTORIAL_PERSONA;

drop table if exists HISTORIAL_RECINTO;
...
drop table if exists RESERVA_RECINTO;

drop table if exists TIPOPER_PRESENTA_TIPOESTPER;

drop table if exists TIPO_ATRIBUTO_AREA;

drop table if exists TIPO_ATRIBUTO_PERSONA;

drop table if exists TIPO_ATRIBUTO_RECINTO;

drop table if exists TIPO_ESTADO_PERSONA;

drop table if exists TIPO_ESTADO_RECINTO;

drop table if exists TIPO_OPERACION_PERSONA;

drop table if exists TIPO_OPERACION_RECINTO;

drop table if exists TIPO_PERSONA;

drop table if exists TIPO_RECINTO;
...
(
   ...
   primary key (ID_TIPO_RECINTO, ID_PERSONA, ID_RECINTO, ID_AREA, ID_USUARIO, ID_HISTORIAL_OCUPAMIENTO_RECINTO)
)
...
(
   ...
   primary key (ID_TIPO_RECINTO, ID_ESTADO_PERSONA, ID_TIPO_OPERACION_PERSONA, ID_PERSONA, ID_USUARIO, ID_RECINTO)
)
...
(
   ...
   primary key (ID_TIPO_RECINTO, ID_TIPO_OPERACION_RECINTO, ID_ESTADO_RECINTO, ID_RECINTO, ID_USUARIO, ID_PERSONA)
)
...
alter table ASIGNACION_PERSONA_RECINTO_AREA add constraint FK_ASIGNACION_PERSONA_RECINTO_AREA4 foreign key (ID_USUARIO)
...
alter table HISTORIAL_PERSONA add constraint FK_HISTORIAL_PERSONA4 foreign key (ID_USUARIO)
      references USUARIO (ID_USUARIO) on delete restrict on update restrict;
...
alter table HISTORIAL_RECINTO add constraint FK_HISTORIAL_RECINTO4 foreign key (ID_USUARIO)
      references USUARIO (ID_USUARIO) on delete restrict on update restrict;
...
alter table RESERVA_RECINTO add constraint FK_USUARIO_REVISA_RESERVA_RECINTO foreign key (ID_USUARIO)
      references USUARIO (ID_USUARIO) on delete restrict on update restrict;
...
alter table USUARIO add constraint FK_PERSONA_USUARIO foreign key (ID_PERSONA)
      references PERSONA (ID_PERSONA) on delete restrict on update restrict;

alter table USUARIO_NOTIFICACION add constraint FK_USUARIO_NOTIFICACION foreign key (ID_USUARIO)
      references USUARIO (ID_USUARIO) on delete restrict on update restrict;

alter table USUARIO_NOTIFICACION add constraint FK_USUARIO_NOTIFICACION2 foreign key (ID_NOTIFICACION)
