...
class PacientesControllerTest < ActionController::TestCase
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post :create, paciente: { idEstadoPaciente: @paciente.idEstadoPaciente, idPersona: @paciente.idPersona, idTipoPaciente: @paciente.idTipoPaciente, perIdPersona: @paciente.perIdPersona }
    end
  ...
  test "should update paciente" do
    patch :update, id: @paciente, paciente: { idEstadoPaciente: @paciente.idEstadoPaciente, idPersona: @paciente.idPersona, idTipoPaciente: @paciente.idTipoPaciente, perIdPersona: @paciente.perIdPersona }
    assert_redirected_to paciente_path(assigns(:paciente))
  end
