class AsignacionesController < ApplicationController
  ...
  private
    ...
    def asignacione_params
      params.require(:asignacione).permit(:idAsignacion, :perIdPersona, :pacIdPersona, :idPersona, :id, :idSala, :idTipoAsignacion, :idCama, :idArea, :iniFechaAsignacion, :iniHoraAsignacion, :finFechaAsignacion, :finHoraAsignacion)
    end
end
